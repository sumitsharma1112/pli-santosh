...
import { PremiumTable } from './types';

export const BONUS_RATE = 52; // Rs. 52 per Rs. 1000 sum assured per year

// Table-II: Monthly Premiums for an assurance of Rs. 5000/-
export const MONTHLY_PREMIUM_TABLE: PremiumTable = {
...
// Table-II-B: Half-Yearly Premiums for an assurance of Rs. 5000/-
export const HALF_YEARLY_PREMIUM_TABLE: PremiumTable = {
...
// Table-II-C: Yearly Premiums for an assurance of Rs. 5000/-
export const YEARLY_PREMIUM_TABLE: PremiumTable = {
